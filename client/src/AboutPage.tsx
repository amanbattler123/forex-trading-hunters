    ...
    <div className="min-h-screen bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: "url('/assets/images/about us background.jpg')" }}>
      ...
      <div className="relative py-10 sm:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12">
            <div className="rounded-2xl border border-emerald-400/30 bg-gradient-to-br from-emerald-900/20 to-blue-900/20 p-8 backdrop-blur shadow-2xl shadow-emerald-500/10">
              <h2 className="text-2xl font-semibold text-white mb-6 text-center">Our Location</h2>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/20 bg-white/10 p-6 text-center backdrop-blur">
              <div className="text-3xl font-semibold text-emerald-400">500+</div>
              <div className="mt-2 text-sm text-white/85">Brokers Reviewed</div>
            </div>
            <div className="rounded-2xl border border-white/20 bg-white/10 p-6 text-center backdrop-blur">
              <div className="text-3xl font-semibold text-emerald-400">10K+</div>
              <div className="mt-2 text-sm text-white/85">Traders Helped</div>
            </div>
            <div className="rounded-2xl border border-white/20 bg-white/10 p-6 text-center backdrop-blur">
              <div className="text-3xl font-semibold text-emerald-400">5+</div>
