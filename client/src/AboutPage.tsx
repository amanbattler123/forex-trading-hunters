      ...
      <div className="relative py-6 sm:py-8 lg:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-12">
            ...
            <p className="mt-3 sm:mt-4 text-sm leading-6 sm:leading-7 text-white/85 max-w-3xl mx-auto">
          ...
          <div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-2">
            <div className="rounded-2xl border border-white/20 bg-white/10 p-4 sm:p-6 lg:p-8 backdrop-blur">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white mb-3 sm:mb-4">Our Mission</h2>
              <p className="text-sm leading-6 sm:leading-7 text-white/85">
            ...
            <div className="rounded-2xl border border-white/20 bg-white/10 p-4 sm:p-6 lg:p-8 backdrop-blur">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white mb-3 sm:mb-4">Our Values</h2>
              <ul className="space-y-2 sm:space-y-3 text-sm leading-6 sm:leading-7 text-white/85">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-12">
            <div className="rounded-2xl border border-emerald-400/30 bg-gradient-to-br from-emerald-900/20 to-blue-900/20 p-4 sm:p-6 lg:p-8 backdrop-blur shadow-2xl shadow-emerald-500/10">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white mb-3 sm:mb-4 lg:mb-6 text-center">Our Location</h2>
              ...
              <div className="mt-3 sm:mt-4 lg:mt-6 flex flex-col items-center gap-2 sm:gap-3">
                ...
                <div className="flex items-center gap-2 text-emerald-400">
                  ...
                  <span className="text-xs sm:text-sm font-medium">London, United Kingdom</span>
                </div>
              </div>
            </div>
          </div>

          <div className="mt-6 sm:mt-8 lg:mt-12 grid gap-3 sm:gap-4 lg:gap-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-white/20 bg-white/10 p-3 sm:p-4 lg:p-6 text-center backdrop-blur">
              <div className="text-xl sm:text-2xl lg:text-3xl font-semibold text-emerald-400">50+</div>
              <div className="mt-1 sm:mt-2 text-xs sm:text-sm text-white/85">Brokers Reviewed</div>
            </div>
            <div className="rounded-2xl border border-white/20 bg-white/10 p-3 sm:p-4 lg:p-6 text-center backdrop-blur">
              <div className="text-xl sm:text-2xl lg:text-3xl font-semibold text-emerald-400">10K+</div>
              <div className="mt-1 sm:mt-2 text-xs sm:text-sm text-white/85">Traders Helped</div>
            </div>
            <div className="rounded-2xl border border-white/20 bg-white/10 p-3 sm:p-4 lg:p-6 text-center backdrop-blur">
              <div className="text-xl sm:text-2xl lg:text-3xl font-semibold text-emerald-400">5+</div>
              <div className="mt-1 sm:mt-2 text-xs sm:text-sm text-white/85">Years Experience</div>
            </div>
          </div>
        </div>
      </div>
